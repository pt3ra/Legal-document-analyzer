...
const profile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    profileImage: null,
    email: 'lianexjustice@gmail.com',
    company: 'Odesа Polytechnic National University',
    position: 'Student',
    joinDate: 'November 24, 2025',
    plan: 'Free',
            ...
            <div className="avatar-section">
              ...
              >
                <span className="material-symbols-rounded">
                  {isEditingImage ? 'close' : 'edit'}
                </span>
                {isEditingImage ? 'Cancel' : 'Edit Image'}
              </button>
            </div>
          ...
          {activeTab === 'profile' && (
            <div className="tab-content">
              ...
              <div className="stats-grid">
                ...
                <div className="stat-card">
                  <div className="stat-icon">
                    <span className="material-symbols-rounded">nest_clock_farsight_analog</span>
                  </div>
                  <div className="stat-info">
              ...
              <div className="info-section">
                ...
                <div className="info-grid">
                  ...
                  <div className="info-item">
                    <label>Subscription Plan [WIP]</label>
                ...
                {isEditing && (
                  <div className="edit-actions">
                    <button 
                      className="btn btn-edit btn-edit-secondary"
                    ...
                    <button 
                      className="btn btn-edit btn-edit-primary"
                      onClick={handleEditToggle}
                    >
